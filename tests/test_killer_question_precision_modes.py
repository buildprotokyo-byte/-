...
def test_precise_mode_treats_tier2_firewall_decisions_as_needing_confirmation() -> None:
    ...
    """
    evidences = [
        AxisEvidence(derivation="read", unit="count", target="x", count_range=(5, 5), source_id="strong-src",
                     axis_id="rules", method_id="strong_method", calibrated=True),
        AxisEvidence(derivation="read", unit="count", target="x", count_range=(4, 6), source_id="weak-src-1",
                     axis_id="history", method_id="prior1", calibrated=True, strength="weak"),
        AxisEvidence(derivation="read", unit="count", target="x", count_range=(4, 6), source_id="weak-src-2",
